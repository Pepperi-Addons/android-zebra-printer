...
class ViewModelFactory(private val repository: Repository, private val connectivityManager : ConnectivityManager? = null, private val zebraApi: ZebraApi?  = null): ViewModelProvider.NewInstanceFactory() {
